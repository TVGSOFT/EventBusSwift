#
#  Be sure to run `pod spec lint EventBusSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Giap Tran" => “tvgsoft@gmail.com" }
  # Or just: s.author    = "Giap Tran"
  # s.authors            = { "Giap Tran" => “tvgsoft@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Giap Tran"
  ...
  s.source_files  = "EventBusSwift", "EventBusSwift/**/*.swift"
